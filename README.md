...
_ No painel de console da AWS crie uma função Lambda:
...
_ Faça o upload do arquivo .zip

![](images/3.png)

_ Em **Handler**, especifique o arquivo e a função a ser usada, ex `create.handler`.
